...
INSERT INTO "new_SiteSettings" ("heroBadge", "heroCtaLink", "heroCtaText", "heroImage", "heroProductId", "heroSubtitle", "heroTitle", "id", "instagram", "mpAccessToken", "mpPublicKey", "storeAccent", "storeBg", "storeFont", "tiktok", "transferAlias", "updatedAt", "whatsapp") SELECT "heroBadge", "heroCtaLink", "heroCtaText", "heroImage", "heroProductId", "heroSubtitle", "heroTitle", "id", "instagram", "mpAccessToken", "mpPublicKey", "storeAccent", "storeBg", "storeFont", "tiktok", "transferAlias", "updatedAt", "whatsapp" FROM "SiteSettings";
